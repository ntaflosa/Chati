...
import {
  ...
  HISTORY_MAX, VAULT_MAX, THEMES, STEP_BODIES, THEME_ICONS,
} from './src/constants.js';
import { Storage } from './src/storage.js';
import { getFormState } from './src/state.js';
import { calculateScore } from './src/score.js';
import { UI_STRINGS, OPTION_LABELS } from './src/i18n.js';
import { COACH_DATA } from './src/coach.js';
import { ONBOARDING_STEPS } from './src/onboarding-data.js';
import { INSPIRE_TOPICS, INSPIRE_ROLES } from './src/inspire.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ONBOARDING_STEPS → src/onboarding-data.js
  ...
  // INSPIRE_TOPICS, INSPIRE_ROLES → src/inspire.js
